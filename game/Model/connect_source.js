 ...
 *  purchaseProp(ITEM, ASYNC_SETTING)：道具購買 return 成功 or 失敗
...
var PrePurchaseProp = { fn: '', context: '' };
var successPurchaseProp = { fn: '', context: '' };
var completePurchaseProp = { fn: '', context: '' };
 ...
 */
function purchaseProp(PROP_KEY, ASYNC_SETTING = true) {

    // 前置函式
    if (typeof PrePurchaseProp.fn === 'function') {
        PrePurchaseProp.fn.call(PrePurchaseProp.context);
    }
    ...
    $.ajax({
        ...
        success: function(result) { // 傳送成功的 function
            if (result.flag == 'success') {
                ...
                // 成功後呼叫
                if (typeof successPurchaseProp.fn === 'function') {
                    successPurchaseProp.fn.call(successPurchaseProp.context);
                }
            }
            // 點數不足
            else if (result.flag == 'no_point') {
        ...
        complete: function(result) { // 無論成功或失敗都呼叫的 function
            // 完成購買後呼叫
            if (typeof completePurchaseProp.fn === 'function') {
                completePurchaseProp.fn.call(completePurchaseProp.context);
            }
        }
    });
}
...
function SetPrePurchaseProp(assignFunction, context = this) {
    Object.defineProperty(PrePurchaseProp, 'fn', {
        value: assignFunction,
        writable: true,
        enumerable: true,
        configurable: true,
    });
    Object.defineProperty(PrePurchaseProp, 'context', {
        value: context,
        writable: true,
        enumerable: true,
        configurable: true,
...
function SetSuccessPurchaseProp(assignFunction, context = this) {
    Object.defineProperty(successPurchaseProp, 'fn', {
        value: assignFunction,
        writable: true,
        enumerable: true,
        configurable: true,
    });
    Object.defineProperty(successPurchaseProp, 'context', {
        value: context,
        writable: true,
        enumerable: true,
        configurable: true,
...
function SetCompletePurchaseProp(assignFunction, context = this) {
    Object.defineProperty(completePurchaseProp, 'fn', {
        value: assignFunction,
        writable: true,
        enumerable: true,
        configurable: true,
    });
    Object.defineProperty(completePurchaseProp, 'context', {
        value: context,
        writable: true,
        enumerable: true,
        configurable: true,
