...
var bootState = {
    preload: function() {
        ...
        game.load.image('loading', '/games/t-iPortfolio/game/Mark/preloader.gif');
        game.load.image('dauchung', '/games/t-iPortfolio/game/Mark/dauchung.png');
    },
...
var loadState = {
    preload: function() {
        ...
        // 加載資源
        game.load.image('cover', '/games/t-iPortfolio/game/Mark/cover01.png'); // 黑色底圖
        game.load.spritesheet('stamp', '/games/t-iPortfolio/game/Mark/stamp.png', 150, 150); // 通關章
        game.load.spritesheet('waiting', '/games/t-iPortfolio/game/Mark/waiting.png', 200, 200); // 倒數三秒進遊戲
        game.load.spritesheet('saving', '/games/t-iPortfolio/game/Mark/saving.png', 300, 300); // 分數儲存中

        game.load.image('logo', '/games/t-iPortfolio/game/games029/assets/logo.png');
        game.load.image('menu', '/games/t-iPortfolio/game/games029/assets/menu.png');
        game.load.image('background', '/games/t-iPortfolio/game/games029/assets/background.png');
        game.load.image('win', '/games/t-iPortfolio/game/games029/assets/win.png');
        game.load.image('fail', '/games/t-iPortfolio/game/games029/assets/fail.png');
        game.load.image('teach', '/games/t-iPortfolio/game/games029/assets/teach.png');
        //下方按鈕組
        game.load.spritesheet('colors', '/games/t-iPortfolio/game/games029/assets/colors.png', 153, 146);
        //按下變色
        game.load.spritesheet('colors2', '/games/t-iPortfolio/game/games029/assets/colors2.png', 153, 146);
        //上方方塊組
        game.load.spritesheet('geoms', '/games/t-iPortfolio/game/games029/assets/geoms.png', 108, 108);

        game.load.image('banner', '/games/t-iPortfolio/game/games029/assets/banner.png');
        game.load.image('freebanner', '/games/t-iPortfolio/game/games029/assets/freebanner.png');
        game.load.image('costbanner', '/games/t-iPortfolio/game/games029/assets/costbanner.png');
        game.load.image('tipsbanner', '/games/t-iPortfolio/game/games029/assets/tipsbanner.png');
        game.load.image('scorebanner', '/games/t-iPortfolio/game/games029/assets/scorebanner.png');

        game.load.image('startBtn', '/games/t-iPortfolio/game/games029/assets/startBtn.png');
        game.load.image('cancleBtn', '/games/t-iPortfolio/game/games029/assets/cancleBtn.png');
        game.load.image('restartBtn', '/games/t-iPortfolio/game/games029/assets/restartBtn.png');
        game.load.image('storeBtn', '/games/t-iPortfolio/game/games029/assets/storeBtn.png');
        game.load.image('bagBtn', '/games/t-iPortfolio/game/games029/assets/bagBtn.png');
        game.load.image('okBtn', '/games/t-iPortfolio/game/games029/assets/okBtn.png');
        game.load.image('login', '/games/t-iPortfolio/game/games029/assets/login.png');
        game.load.image('rank', '/games/t-iPortfolio/game/games029/assets/rank.png');
        game.load.image('bag', '/games/t-iPortfolio/game/games029/assets/bag.png');
        game.load.spritesheet('LINEshare', '/games/t-iPortfolio/game/games029/assets/LINEshare.png', 40, 40, 2);
        game.load.spritesheet('FBshare', '/games/t-iPortfolio/game/games029/assets/FBshare.png', 40, 40, 2);

        game.load.bitmapFont('BMFont_White', '/games/t-iPortfolio/game/Font/BMFont_White.png', '/games/t-iPortfolio/game/Font/BMFont_White.fnt');
        game.load.bitmapFont('BMFont_Black', '/games/t-iPortfolio/game/Font/BMFont_Black.png', '/games/t-iPortfolio/game/Font/BMFont_Black.fnt');

        game.load.audio('bgm', '/games/t-iPortfolio/game/games029/assets/audio/bgm.mp3');
        game.load.audio('click', '/games/t-iPortfolio/game/games029/assets/audio/click.mp3');
        game.load.audio('start', '/games/t-iPortfolio/game/games029/assets/audio/start.mp3');
        game.load.audio('story', '/games/t-iPortfolio/game/games029/assets/audio/story.mp3');
        game.load.audio('correct', '/games/t-iPortfolio/game/games029/assets/audio/correct.mp3');
        game.load.audio('error', '/games/t-iPortfolio/game/games029/assets/audio/error.mp3');
        game.load.audio('dead', '/games/t-iPortfolio/game/games029/assets/audio/dead.mp3');
    },
...
var gameState = {
    ...
    create: function() {
        ...
        // game.add.text(12, 10, 'ID: ' + PlayerID, { fill: '#444', fontSize: "12px" });
        // game.add.text(10, 25, 'SN: ' + PlayerSN, { fill: '#444', fontSize: "12px" });
        ...
        // 創建按鈕
        for (var j = 0; j < 3; j++) {
            this.arrpos[j] = game.add.sprite(0, game.world.height, 'colors', this.arr[j]);
            this.arrpos[j].x = this.arrpos[j].width * (j + 0.95);
            this.arrpos[j].anchor.setTo(1, 1);
            this.arrpos[j].originFrame = this.arr[j];
            this.arrpos[j].inputEnabled = true;

            this.arrpos[j].events.onInputOver.add(function(e) {
                this.onrelease(e)
            }, this);
            this.arrpos[j].events.onInputOut.add(function(e) {
                this.onrelease(e)
            }, this);
            this.arrpos[j].events.onInputUp.add(function(e) {
                this.onrelease(e)
            }, this);
            this.arrpos[j].events.onInputDown.add(function(e) {
                this.onPress(e)
            }, this);
        }
    ...
    onrelease(btn) {
        btn.loadTexture('colors', btn.originFrame);
    },

    onPress(btn) {
        btn.loadTexture('colors2', btn.originFrame);
        this.press(btn, btn.originFrame);
    },
    ...
    press: function(sprite, frame) {
        if (this.row.getChildAt(this.row.length - 1).frame == frame) {
            PlayAudio('correct', 1);
            this.row.getChildAt(this.row.length - 1).destroy();
            this.showPoint(sprite);
...
var menuState = {
    create: function() {
        ...
        //             board.addChild(game.add.bitmapText(55, 40, 'BMFont_White', MemberFreeTimes, 14));
        //         } else {
        //             board = game.add.sprite(game.world.centerX, game.world.centerY, 'costbanner');
        //             board.addChild(game.add.bitmapText(30, 30, 'BMFont_White', GameCostPoint, 22)).anchor.setTo(1);
        //             board.addChild(game.add.bitmapText(30, 37, 'BMFont_White', MemberPoint, 14));
        //         }
...
var overState = {
    create: function() {
        ...
        game.add.bitmapText(game.world.centerX, game.world.centerY + 25, 'BMFont_White', score, 22).anchor.setTo(0.5);

        var stamp = game.add.sprite(game.world.centerX + 70, game.world.centerY - 80, 'stamp');
        stamp.scale.setTo(0.7);
        stamp.alpha = 0;
        // if (IsLogin && GameType == 'beating' && MemberWinFlag) {
        //     setTimeout(function() {
        //         stamp.alpha = 1;
